class DesktopApp extends React.Component {
    render() {
        return <div className = "desktop-app">
            <div className = "desktop-app__download-logo">
            ...
            <div className = "desktop-app__btns">
                ...
                <button className = "desktop-app__btns__samp">
                    ...
                    <p className = "desktop-app__btns__statment">Download for Windows</p>
                </button>
