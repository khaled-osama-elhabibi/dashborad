                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "span",
                            {
                                className: "monitor__record__number-assign " + "monitor__record__number-assign--" + this.props.target },
                            this.props.number
                        ),
                        "/82"
                    )
                ),
                React.createElement("img", { className: "monitor__sign", src: this.props.logoPath })
            );
        }
    }]);
