...
var MainRow = function (_React$Component2) {
    _inherits(MainRow, _React$Component2);

    function MainRow() {
        _classCallCheck(this, MainRow);

        return _possibleConstructorReturn(this, (MainRow.__proto__ || Object.getPrototypeOf(MainRow)).apply(this, arguments));
    }
...
var MainTable = function (_React$Component3) {
    _inherits(MainTable, _React$Component3);
    ...
    _createClass(MainTable, [{
        ...
        value: function render() {
            return React.createElement(
                "div",
                { className: "main-table__container" },
                React.createElement(
                    "table",
